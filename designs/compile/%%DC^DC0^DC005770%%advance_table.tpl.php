<?php /* Smarty version 2.6.26, created on 2022-01-18 10:58:06
         compiled from advance_table.tpl */ ?>
<!--main content start-->
                        ...
                        <td><?php echo $this->_tpl_vars['d']['dob']; ?>
                          ...
                          <td><?php echo $this->_tpl_vars['d']['officeaddress']; ?>
                            ...
                            <td><?php echo $this->_tpl_vars['d']['city']; ?>
                              ...
                              <td><a href="approvecontroller.php?key=<?php echo $this->_tpl_vars['d']['loginkey']; ?>
"><button type="button" style="background: green;color: white">Approve</button></a></td>
                             <td> <a href="rejectcontroller.php?key=<?php echo $this->_tpl_vars['d']['loginkey']; ?>
