<?php /* Smarty version 2.6.26, created on 2022-01-20 09:20:50
         compiled from productsubcategory.tpl */ ?>
        ...
        <div class="row mb">
          ...
          <div class="content-panel">
            <div class="adv-table">
             ...
             <!--      
                    <td>mmmmm</td> 
                    <button type="button" style="background: green;color: white">Update</button>

                      <td><button type="button" style="background: red; color: white">Delete</button></a></td></td> -->
