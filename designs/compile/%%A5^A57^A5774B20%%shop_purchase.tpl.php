<?php /* Smarty version 2.6.26, created on 2022-02-13 05:50:37
         compiled from shop/shop_purchase.tpl */ ?>
 ...
 <!-- <div class="w3l-content-1 w3l-progressblock py-5"> -->
  ...
  <h6 class="title-subhny two mb-2"><span>Product Purchase</span></h6>
</div>
<br>
 	<form method="POST" action="" style="color: white">
		...
		<table align="center" cellspacing="10px" cellpadding="10px">
			...
			<tr>
				<td>Product</td><td><input type="text" name="name" class="form-control"></select></td>
			</tr>
			<tr>
