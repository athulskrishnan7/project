<?php /* Smarty version 2.6.26, created on 2022-02-13 11:05:42
         compiled from user/userheader.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<!-- basic -->
            ...
            <div id="navbar_menu">
              <ul class="first-ul">
                ...
                <li> <a href="#">Complaint</a>
                  <ul>
                    <li><a href="user_complaint.php">Send Complaint</a></li>
                    <li><a href="user_viewcomplaint.php">View Complaint</a></li>
                  </ul>
                </li>
                ...
                <li> <a href="user_update.php?key=<?php echo $this->_tpl_vars['key']; ?>
">User Update</a>
