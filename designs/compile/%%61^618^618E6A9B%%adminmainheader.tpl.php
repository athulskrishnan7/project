<?php /* Smarty version 2.6.26, created on 2022-02-04 07:16:32
         compiled from admin/adminmainheader.tpl */ ?>
    <!DOCTYPE html>
<html lang="en">
...
<!--sidebar start-->
    <aside>
      <div id="sidebar" class="nav-collapse ">
       ...
       <li class="sub-menu">
            <a href="admin_shoptaxview.php">
              <i class="fa fa-tasks"></i>
              <span>Shop tax report</span>
              </a>
          ...
          <li>
            <a href="admin_complaintview.php">
