<?php /* Smarty version 2.6.26, created on 2022-01-16 10:38:29
...
<!-- Meta tag Keywords -->
<!-- css files -->
<link href="login/web/css/style.css" rel="stylesheet" type="text/css" media="all">
<!-- online-fonts -->
...
<div class="w3layouts-main">
	<h2>Login Now</h2>
		<form action="#" method="post">
			...
			<input value="" name="email" type="email" required="" onfocus="this.value = \'\';" onblur="if (this.value == \'\') {this.value = \'E-Mail\';}"/>
			<input value="" name="password" type="password" required="" onfocus="this.value = \'\';" onblur="if (this.value == \'\') {this.value = \'password\';}"/>
