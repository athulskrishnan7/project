<?php /* Smarty version 2.6.26, created on 2022-01-19 09:57:44
         compiled from subadminside.tpl */ ?>
<!--slider menu-->
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="#"><i class="fa fa-cogs"></i><span>Product Tax</span><span class="fa fa-angle-right" style="float: right"></span></a>
		          <ul>
		            <li><a href="productcategory.php">Product category</a></li>
		            <li><a href="portlet.html">Product sub category</a></li>		            
		          </ul>
		        </li>
